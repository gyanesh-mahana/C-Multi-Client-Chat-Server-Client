...
#define HEADER_LENGTH_BITS			16	// MUST BE DEFINED AS ONE OF THE FOLLOWING {8, 16, 24, 32}
#define HEADER_LENGTH				HEADER_LENGTH_BITS / 8
#define MAX_PAYLOAD_LENGTH			(int) (pow(2, HEADER_LENGTH_BITS) - 1)		
#define MAX_PACKET_LENGTH			HEADER_LENGTH + MAX_PAYLOAD_LENGTH
...
#define PAYLOAD_LENGTH_TYPE			X_PAYLOAD_TYPE(HEADER_LENGTH_BITS)
